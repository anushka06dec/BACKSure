	            ...
	            <div className="container">
	                <div className="row">
	                    <div className="col-lg-12">
	                        <ul className="home-block-list block-list mobile-slider d-md-flex flex-md-wrap flex-md-row-reverse">
	                            <li className="block-item">
	                                <div className="block-box d-flex flex-column">
	                                    ...
	                                    <div className="block-btn"><Link to="/what-we-get" className="btn btn-primary">FIND OUT MORE</Link></div>
	                                </div>
	                            </li>
	                            <li className="block-item">
	                                <div className="block-box d-flex flex-column">
